...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total number of deadlines using streams: " + countDeadlinesUisngStreams(tasksData));
    ...
    public static int countDeadlinesUisngStreams(ArrayList<Task> tasksData) {
